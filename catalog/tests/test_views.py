...
class AuthorCreateViewTest(TestCase):
    ...
    def test_logged_in_with_permission_add(self):
    ...
    def test_initial_date(self):
        ...
        death_date = '11/11/2023'
        self.assertEquals(death_date, response.context['form'].initial['date_of_death'])
    ...
    def test_redirects_to_authors_on_success(self):
        ...
        response = self.client.post(reverse('author-create'),{
            'first_name': 'George',
            'last_name': 'Orwell',
            'date_of_birth': '06/25/1903',
            'date_of_death': '01/21/1950'
        }) 
